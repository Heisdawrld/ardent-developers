    ...
    <section className="relative">
      ...
      <div className="relative w-full h-[80vh] lg:h-[92vh] bg-foreground overflow-hidden">
        ...
        */}
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-foreground via-foreground/85 to-accent/40" />
        ...
        <div className="relative z-10 h-full max-w-[1400px] mx-auto px-6 lg:px-10 flex flex-col justify-end pb-16 lg:pb-24">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <p className="text-leaf text-[12px] font-medium tracking-[0.25em] uppercase mb-4">
              Lagos · Nigeria
            </p>

            {/* Cursive accent word above the project name (Habitat signature) */}
            <p className="font-script text-leaf text-4xl md:text-5xl lg:text-6xl leading-none mb-3 -ml-1">
              The Residences
            </p>
        ...
        <a
          ...
          className="absolute bottom-6 right-6 z-20 flex items-center gap-2 px-4 py-2.5 bg-leaf text-foreground text-xs font-semibold rounded-full shadow-lg hover:bg-leaf/90 transition-colors"
        >
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10">
        ...
        <LeafDecor
          variant="leaf"
          className="top-4 -left-6 w-24 text-leaf opacity-[0.18] hidden lg:block"
        />
