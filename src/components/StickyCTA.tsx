...
/**
 * StickyCTA — Habitat's signature bottom-of-screen CTA bar.
 *
 * Appears as a sticky pill at the bottom of the viewport once the user
 * scrolls past the hero. Contains two buttons:
 *   1. "Pricing" (with right-arrow icon)
 *   2. "Download Brochure" (with down-arrow icon)
 *
 * Habitat pattern: position: sticky; bottom: 10px; z-index: 1000;
 * Inner .bottom-wrap is a pill with backdrop-filter blur,
 * background rgba(250, 247, 240, 0.25), padding 4px, border-radius 60px.
 */
export default function StickyCTA() {
  ...
  return (
    ...
    >
      <div
        className="flex items-center glass-cream"
        style={{
          padding: 4,
          borderRadius: 60,
          height: 60,
      ...
      >
        ...
        >
          <span className="btn-txt">NGN 2.95M per Plot</span>
