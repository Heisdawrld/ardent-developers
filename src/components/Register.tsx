...
/**
 * Register — Hybrid Habitat + Kota No.1.
 *
 * Replaces Habitat's image-overlay price card with a Kota-style
 * "Schedule of Areas" structured table on a warm dark backdrop,
 * plus investment highlights row. Keeps the brochure form pattern.
 */
...
/** Kota-style Schedule of Areas data */
const PLOT_TYPES = [
  {
    type: "Starter Plot",
    size: "600 SQM",
...
const INVESTMENT_HIGHLIGHTS = [
  { number: "₦2.95M", label: "Entry price — plots starting at 600 SQM with full servicing included." },
  { number: "50", label: "Free trees per plot (300 trees per acre) — instant agrihood yield." },
  { number: "2028", label: "Year the Lekki-Ijebu corridor opens — 15 mins from Lekki Free Zone." },
];
    ...
    <div id="pricing" className="price-super-container">
      <div className="adventure-section">
        <section>
          ...
          {/* ===== Kota-style Schedule of Areas table ===== */}
          <div className="schedule-of-areas">
            <div className="schedule-header">
              <div className="title-block">
                <div className="eyebrow">02 · Pricing</div>
                <h2>Schedule of Areas</h2>
              </div>
              <div className="meta">
                Phase 1 · 25 acres · Epe-Ibeju axis<br />
                Launch sale ongoing · 60 mins from VI
              </div>
            </div>
            ...
            <table className="schedule-table">
              ...
              <tbody>
                {PLOT_TYPES.map((plot) => (
                  <tr key={plot.type}>
                    <td className="plot-type">{plot.type}</td>
                    <td className="plot-size">{plot.size}</td>
                    <td className="plot-price">{plot.price}</td>
                    <td className="plot-status">
                      <span className={`badge ${plot.statusType}`}>
                        {plot.status}
                      </span>
                    </td>
                  </tr>
            ...
            {/* Investment highlights — Kota-style 3-col row */}
            <div className="investment-highlights">
              {INVESTMENT_HIGHLIGHTS.map((item) => (
                <div key={item.number} className="highlight">
          ...
          <div className="container-img">
            ...
            <div className="brochure-form-container">
              ...
              <div className="left">
                ...
                >
                  <g opacity="0.5">
                    <line x1="4" y1="60" x2="4" y2="0" stroke="var(--cream)" strokeWidth="2" />
                    <rect x="11" width="3" height="60" rx="1.5" fill="var(--cream)" />
                    <rect x="20" width="5" height="60" rx="2.5" fill="var(--cream)" />
                    <rect x="31" width="7" height="60" rx="3.5" fill="var(--cream)" />
                    <rect x="44" width="9" height="60" rx="4.5" fill="var(--cream)" />
                    <rect x="59" width="11" height="60" rx="5.5" fill="var(--cream)" />
                    <rect x="76" width="13" height="60" rx="6.5" fill="var(--cream)" />
                    <rect x="95" width="15" height="60" rx="7.5" fill="var(--cream)" />
                    <rect x="116" width="17" height="60" rx="8.5" fill="var(--cream)" />
                    <rect x="139" width="19" height="60" rx="9.5" fill="var(--cream)" />
                  </g>
                </svg>
              </div>
              ...
              >
                ...
                <div className="btn-wrap">
                  <button type="submit" className="link-button" style={{ width: "100%" }}>
